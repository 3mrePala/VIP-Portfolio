...
import { commercialExperienceConfig } from "../config/resume/commercialExperienceConfig";
    ...
    <div id="resume" className="container">
      ...
      <div className="resume__wrapper">
        <div className="resume__grid" data-aos="fade-up" data-aos-delay="500">
          ...
          <div>
            <div className="resume__name playfair">Emre Pala</div>
            ...
            <div className="resume__contact--info">
              ...
              <div>
                <MdEmail />
                <a className="resume__link" href="mailto:emre@emrepala1.com">
                  Email
                </a>
              </div>
              <div>
        ...
        <div className="resume__grid" data-aos="fade-up" data-aos-delay="500">
          <div className="resume__title--description">Commercial Experience</div>
          <div>
            {commercialExperienceConfig.map((commercial, index) => (
              <div className="resume__job--wrapper" key={index}>
                <div className="resume__job">
                  <div>
                    <div className="resume__job--name">{commercial.name}</div>
                    <div className="resume__job--description">
                      {commercial.title}
                    </div>
                  </div>
                ...
                <ul className="resume__list-wrapper">
                  {commercial.description.map((description, index) => (
                    <li key={index}>{description}</li>
                  ))}
                </ul>
              </div> 
